			...
			<section role="main" class="content-body">
				...
				<section class="panel">
					<header class="panel-heading">
						...
						<h2 class="panel-title">Welcome to your Admin Panel <span class="name"><?php echo $_SESSION['name']; ?></span> !</h2> <br>
						<p class="panel-subtitle">
							Here you can find <code>tools to manage </code>your page restaurant and bookings : Types of Tables, Numbers of each tables, Menu items, Bookings actions...
							<hr>
